  ...
  return (
    <div className="max-w-[1230px] mx-auto px-2 min-h-screen">
      <h1 className="text-3xl text-center font-semibold my-5">
        Your Added <span className="text-[#22A1F0]">Products in The Cart</span>
      </h1>
      ...
      <div className="bg-slate-50 lg:mt-0 mt-8 ml-3 rounded-md fixed lg:w-64 w-[90%] md:w-72 top-100 md:top-40 md:right-5 h-auto md:h-72 border border-[#21A0F3] shadow-lg p-4">
